				...
				<div class="container">
					...
					<div class="w3ls-header-right">
						<ul> 
							...
							<li class="head-dpdn">
								<a href="./storelogin.sto"><i class="fa fa-sign-in" aria-hidden="true"></i> 사장님 로그인</a>
							</li> 
							<li class="head-dpdn">
								<a href="./storejoin.sto"><i class="fa fa-user-plus" aria-hidden="true"></i> 사장님 회원가입</a>
							</li> 
							<li class="head-dpdn"> 
