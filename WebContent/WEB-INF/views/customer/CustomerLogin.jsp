		...
		<div class="container"> 
			...
			<div class="login-agileinfo"> 
				<form action="./login.cus" method="post"> 
					<input class="agile-ltext" type="text" name="cusid" placeholder="Username" required="required">
					<input class="agile-ltext" type="password" name="cuspw" placeholder="Password" required="required">
